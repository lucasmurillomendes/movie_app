...
import androidx.compose.material.OutlinedTextField as OutilinedTextField

@Composable
fun SearchComponent(
    modifier: Modifier = Modifier,
    query: String,
    onQueryChangeEvent: (MoviesSearchEvent) -> Unit,
    onSearch: (String) -> Unit
) {
    OutilinedTextField(
        value = query,
        onValueChange = {
            onQueryChangeEvent(MoviesSearchEvent.EnteredQuery(it))
        },
        trailingIcon = {
            IconButton(
                onClick = {
